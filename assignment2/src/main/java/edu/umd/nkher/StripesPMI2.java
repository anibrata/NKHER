...
public class StripesPMI2 extends Configured implements Tool {

  private static final Logger LOG = Logger.getLogger(StripesPMI2.class);
...
"/user/hdedu6/lines");
  ...
  public int run(String[] args) throws Exception {
    ...
    LOG.info("Tool name: " + StripesPMI2.class.getSimpleName());
    ...
    firstJob.setJarByClass(StripesPMI2.class);
    ...
    secondJob.setJobName(StripesPMI2.class.getSimpleName());
    secondJob.setJarByClass(StripesPMI2.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new StripesPMI2(), args);
  }
