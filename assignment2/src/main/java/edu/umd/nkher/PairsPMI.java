...
public class PairsPMI extends Configured implements Tool {
  ...
  protected static class MyReducer extends
	  ...
	  private static final DoubleWritable FINAL_COUNT = new DoubleWritable();
	    ...
	    PairOfStrings mypair = new PairOfStrings("hello", "namesh");
	    private static DoubleWritable SIZE = new DoubleWritable();
	    
	    // hashmap to store the words and the co occurences
	    private static HashMap<String, Double> dictionary =
	        new HashMap<String, Double>();
	    private static HashMap<PairOfStrings, DoubleWritable> coocurMap =
	            new HashMap<PairOfStrings, DoubleWritable>();
    ...
    public void reduce(PairOfStrings key, Iterable<DoubleWritable> values,
      ...
      if (key.getLeftElement().equals("")) {
        dictionary.put(key.getRightElement(), sum);
      }
