...
public class HBaseWordCount extends Configured implements Tool {
  ...
  Logger LOG = Logger.getLogger(HBaseWordCount.class);
  ...
  public static class MyTableReducer extends TableReducer<Text, IntWritable, ImmutableBytesWritable> {
    ...
    public void reduce(Text key, Iterable<IntWritable> values, Context context)
      ...
      put.add(CF, COUNT, Bytes.toBytes(sum)); // family, qualifier, value
  ...
  public int run(String[] args) throws Exception {
    ...
    // conf.addResource(new Path("/hbase-0.94.27/conf/hbase-site.xml"));
